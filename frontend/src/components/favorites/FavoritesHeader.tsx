...
export function FavoritesHeader({ totalCount }: FavoritesHeaderProps) {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-white/[0.08] via-white/[0.03] to-transparent p-6 backdrop-blur-xl sm:p-10">
      <div className="pointer-events-none absolute -top-24 -right-24 size-72 rounded-full bg-violet-500/15 blur-3xl" />
      <div className="pointer-events-none absolute -bottom-24 -left-24 size-72 rounded-full bg-emerald-500/15 blur-3xl" />
      ...
      <div className="relative flex flex-col gap-6 sm:flex-row sm:items-start sm:justify-between">
        <div className="max-w-2xl">
          ...
          <p className="mt-3 text-base text-white/65 sm:text-lg">
            Your saved songs and personal collection.
          </p>
        </div>
        ...
        <div className="flex items-center gap-4 sm:flex-col sm:items-end">
          ...
          <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-black/25 px-4 py-3 backdrop-blur">
            <div className="grid size-10 place-items-center rounded-xl bg-rose-500/15">
            ...
            <div>
              ...
              <p className="text-xs text-white/55">Saved tracks</p>
            </div>
          </div>
        </div>
      </div>
